              ...
              <div class="bd-highlight w-50">
                <div class="d-flex flex-column bd-highlight vision-right mt-3">
                  <div class="p-2 bd-highlight mt-5">
                    <h3 class="text-start">1. TẦM NHÌN</h3>
                    <p class="text-start">
                  ...
                  <div class="p-2 bd-highlight mt-2">
                    <h3 class="text-start">2. SỨ MỆNH</h3>
                    <p class="text-start">
                  ...
                  <div class="p-2 bd-highlight mt-2">
                    <h3 class="text-start">3. GIÁ TRỊ CỐT LÕI</h3>
                    <p class="text-start">Năng động – Sáng tạo – Chuyên nghiệp</p>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div class="container-fluid services">
                  <div class="services d-flex flex-row w-100">
                    ...
                    <div class="services-right w-50">
                      <p class="title-1 text-start text-uppercase">CÔNG NGHỆ NỔI BẬT</p>
                      <a class="title-2 text-start" href="#">CÔNG NGHỆ CHỌN TẠO GIỐNG CÂY TRỒNG</a>
                      <p class="title-3 text-start">
                        Vinaseed là doanh nghiệp KHCN đầu tiên trong ngành giống cây
                        trồng Việt Nam, tiên phong trong hoạt động nghiên cứu, ứng
                        dụng và chuyển giao công nghệ với các giải pháp đột phá, đi
                        trước và định hướng thị trường. Hệ thống cơ sở hạ tầng phục vụ
                        nghiên cứu hiện đại, đội ngũ chuyên gia hùng hậu, nhân sự trên
                        1000 lao động với 80% có trình độ đại học và trên đại học hoàn
                        toàn làm chủ công nghệ chọn tạo giống tiên tiến trên thế giới,
                        công nghệ sản xuất hạt lai, công nghệ sản xuất nông nghiệp
                        4.0.
                      </p>
                    </div>
                  </div>
              ...
              <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                <div class="container-fluid">
                  <div class="services d-flex flex-row w-100">
                    ...
                    <div class="services-right w-50">
                      <p class="title-1 text-uppercase">CÔNG NGHỆ NỔI BẬT</p>
                      <a class="title-2" href="#">CÔNG NGHỆ CHỌN TẠO GIỐNG CÂY TRỒNG</a>
                      <p class="title-3">
                        Vinaseed là doanh nghiệp KHCN đầu tiên trong ngành giống cây
                        trồng Việt Nam, tiên phong trong hoạt động nghiên cứu, ứng
                        dụng và chuyển giao công nghệ với các giải pháp đột phá, đi
            ...
            <div class="tab-content" id="myTabContent">
              <div class="tab-pane fade show active" id="home1" role="tabpanel" aria-labelledby="home-tab-1">
                <div class="container-fluid services">
                  <div class="services d-flex flex-row w-100">
                    <div class="services-right w-50">
                      <p class="title-1 text-start text-uppercase">lĩnh vực kinh doanh</p>
                      <a class="title-2 text-start" href="#">CÔNG NGHỆ CHỌN TẠO GIỐNG CÂY TRỒNG</a>
                      <p class="title-3 text-start">
                        Vinaseed là doanh nghiệp KHCN đầu tiên trong ngành giống cây
                        trồng Việt Nam, tiên phong trong hoạt động nghiên cứu, ứng
              ...
              <div class="bd-highlight w-40 news-right">
                <div class="d-flex flex-column bd-highlight">
                  <div class="bd-highlight mt-3 news-right__link">
                    <a href="#">
                      <p class="mb-0 text-uppercase">Tin tức</p>
                    </a>
                  </div>
